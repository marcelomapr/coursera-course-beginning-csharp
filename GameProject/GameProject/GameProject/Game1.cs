...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            teddyBearProjectileSprite = new Projectile(Content, (@"Graphics/teddybearprojectile"), GameConstants.WindowWidth / 2, GameConstants.WindowHeight * 7 / 8, null)
            frenchFriesSprite = new Projectile(Content, (@"Graphics/frenchfries"), GameConstants.WindowWidth / 2, GameConstants.WindowHeight * 7 / 8, null)
        ...
        private void SpawnBear()
        {
            ...
            float speed = RandomNumberGenerator.NextFloat(GameConstants.MinBearSpeed+GameConstants.BearSpeedRange);
            float angle = RandomNumberGenerator.NextFloat(2 * (float) Math.PI);

            Vector2 speedVector = new Vector2((speed * (float) Math.Cos(angle)), (speed * (float) Math.Sin(angle)));

            // create new bear
            TeddyBear newBear = new TeddyBear(Content, (@"Graphics/teddybear"), x, y, speedVector, null, null);
